...
def main(): 
    ...
    img_obj_list = [w_king, w_queen, w_rook, w_bishop, w_knight, w_pawn, b_king, b_queen, b_rook, b_bishop, b_knight, b_pawn]
    #pdb.set_trace()
    ...
    #gui.after(1000, update_board(canvas, STATE_OF_BOARD, img_obj_dict))
    gui.mainloop() 
...
def put_down_pc(event, canvas, state_of_board, img_obj_dict): 
        global EVENT_LIST
        global STATE_OF_BOARD
        global PREVIOUS_PIECE
        global LAST_POSITION
